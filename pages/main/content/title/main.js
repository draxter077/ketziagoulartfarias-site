...
export default function title(){
    ...
    let text = '06 - 07/06/2025, Ibis <br> <br> Se, quando te vi pela primeira vez, sabia que iria gostar muito de você, então, quando acordei e te vi do meu lado, sabia que iria te amar por muito, muito tempo. <br> Dê uma olhadinha nas músicas aqui embaixo...'
    text = text.split(" ")
